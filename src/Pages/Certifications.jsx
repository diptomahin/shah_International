...
const Certifications = () => {
  ...
  'Bangladesh Association of International Recruiting Agencies (BAIRA) Member',
  'Ministry of Expatriates\' Welfare Licensed',
  'Mauritius Labor Department Approved',
  'Ethical Recruitment Certified',
  'International Labour Organization (ILO) Compliant'
];
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Recognized and certified by leading national and international
            organizations
          </p>
        </div>
