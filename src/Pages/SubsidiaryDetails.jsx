    ...
    <div>
      <div className="py-12 px-4 max-w-5xl mx-auto">
        ...
        <div className="bg-white shadow rounded-xl p-8">
          <h1 className="text-4xl font-bold text-[#2d3190]">
            {subsidiary.name}
          </h1>
        ...
        <section className="mt-12 mb-10 bg-white rounded-2xl p-6 md:p-8 shadow-xl border-t-4 border-[#2d3190]">
          ...
          <div className="flex flex-col md:flex-row items-start gap-6 mb-8">
            ...
            <blockquote className="border-l-4 border-gray-200 pl-4 italic text-gray-700">
              ...
              <strong> {proprietorInfo.yearsExperience} years</strong> in
              sending skilled Bangladeshi workers abroad."
            </blockquote>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 sm:gap-6 mb-6">
            ...
            <div className="p-4 bg-blue-50 rounded-lg">
              ...
              <p className="text-sm text-gray-700">
                Training center, transport, and complete worker support
                included.
              </p>
            </div>
          </div>
